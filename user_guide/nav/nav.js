function create_menu(basepath)
{
	...
	document.write(
		...
		'<h3>Installation</h3>' +
		'<ul>' +
			'<li><a href="'+base+'installation/downloads.html">Downloading Mangu</a></li>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'overview/at_a_glance.html">Mangu at a Glance</a></li>' +
			'<li><a href="'+base+'overview/cheatsheets.html">Mangu Cheatsheets</a></li>' +
		...
		'<ul>' +
			'<li><a href="'+base+'general/urls.html">Mangu URLs</a></li>' +
			...
			'<li><a href="'+base+'general/libraries.html">Using Mangu Libraries</a></li>' +
			'<li><a href="'+base+'general/creating_libraries.html">Creating Your Own Libraries</a></li>' +
			'<li><a href="'+base+'general/drivers.html">Using Mangu Drivers</a></li>' +
		...
		'<ul>' +
		'<li><a href="http://mangu.madradavid.com/forums/">Community Forums</a></li>' +
		'<li><a href="http://mangu.madradavid.com/wiki/">Community Wiki</a></li>' +
		'</ul>' +
